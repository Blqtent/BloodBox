...
void Item::draw(gl2d::Renderer2D &renderer, gl2d::Texture medkitTexture, gl2d::Texture bateryTexture, gl2d::Texture pillsTexture, gl2d::Texture akTexture, gl2d::Texture glockTexture)
	{
		...
		if (itemType == itemTypePills)
		{
			t = pillsTexture;
		}
		if (itemType == itemTypeAk)
		{
			t = akTexture;
		}
		if (itemType == itemTypeGlock)
		{
			t = glockTexture;
		}
